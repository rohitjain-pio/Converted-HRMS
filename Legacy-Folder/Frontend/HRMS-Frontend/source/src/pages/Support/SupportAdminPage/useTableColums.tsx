...
import { FeedbackType } from "@/services/Support/types";
...
export const useTableColumns = ({ pagination }: UseTableColumnsProps) => {
  ...
  const columns = useMemo<MRT_ColumnDef<FeedbackType>[]>(
    () => [
      {
        header: "Support ID",
        accessorKey: "id",
      ...
      },
      {
        ...
        enableSorting:false,
        accessorFn: (row) =>row.modifiedOn? formatDate(row.modifiedOn):"N/A",
        size: 150,
      },
