...
class MenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Exit Management Submenus
        $myResignation = Menu::create([
            'menu_name' => 'My Resignation',
            'menu_path' => '/my-resignation',
            'icon' => 'mdi-account-arrow-right',
            'parent_menu_id' => $exit->id,
            'display_order' => 1,
            'is_active' => true,
        ]);
        $this->attachPermissions($myResignation, [
            Permissions::EXIT_INITIATE,
        ]);

        $adminResignations = Menu::create([
            'menu_name' => 'Manage Resignations',
            'menu_path' => '/admin/resignations',
            'icon' => 'mdi-account-multiple-remove',
            'parent_menu_id' => $exit->id,
            'display_order' => 2,
            'is_active' => true,
        ]);
        $this->attachPermissions($adminResignations, [
            Permissions::EXIT_APPROVE,
            Permissions::EXIT_REJECT,
